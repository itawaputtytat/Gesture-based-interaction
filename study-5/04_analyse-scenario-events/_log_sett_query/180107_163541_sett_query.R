...
sett_query$sxx_exx <- "s01_e01" ## turning; could be significant look for brake pressure bar >= 3 (or 7) and look for outliers
sett_query$sxx_exx <- "s01_e03" ## single pedestrian; s when single-sided

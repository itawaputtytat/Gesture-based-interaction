...
ggsave(filename = "q_nasatlx_motorway_boxplot_expfocus.png",
       plot = plot(plotdata),
...
ggsave(filename = "q_nasatlx_motorway_boxplot_typegeneric.png",
       plot = plot(plotdata),
       path = file.path(set4plot$dir4plot, "boxplots"), 
       width = 12.5, height = 6, units = "cm", dpi = 600)
...
ggsave(filename = "q_nasatlx_motorway_itemprofile_expfocus.png",
       plot = plotdata,
...
ggsave(filename = "q_nasatlx_motorway_itemprofile_typegeneric.png",
       plot = plotdata,
       path = file.path(set4plot$dir4plot, "itemprofiles"),
       width = 15, height = 9 * 0.85, units = "cm", dpi = 600)
